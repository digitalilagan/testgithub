...
mix.babel('node_modules/izitoast/dist/js/iziToast.min.js',
 ...
 mix.js('resources/assets/js/profile_j_qs/profile_j_qs.js', 'public/assets/js/profile_j_qs/profile_j_qs.js').version();


 mix.js('resources/assets/js/settings/settings.js', 'public/assets/js/settings/settings.js').version();


 mix.js('resources/assets/js/testnotables/testnotables.js', 'public/assets/js/testnotables/testnotables.js').version();
